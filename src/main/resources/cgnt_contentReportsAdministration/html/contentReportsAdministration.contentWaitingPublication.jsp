            ...
            <div class="col-md-12">
                <div class="panel panel-primary panel-primary-datatables filterable">
                    ...
                    <div class="panel-heading">
                        <h5 class="panel-title" id=""><fmt:message key="cgnt_contentReports.report"/>&nbsp;<fmt:message key="cgnt_contentReports.menu.contentReports.contentWaitingPublication"/></h5>
                    </div>

                    <table width="100%" class="display reports-data-table" id="waitingContentTable" cellspacing="0">
                        <thead>
                            <tr>
                                ...
                                <th><fmt:message key="cgnt_contentReports.report.column.workflowStarted"/></th>
                                <th><fmt:message key="cgnt_contentReports.report.column.workflowName"/></th>
                                <th><fmt:message key="cgnt_contentReports.report.column.workflowType"/></th>
<%--
                                <c:forEach var="lang" items="${renderContext.site.languagesAsLocales}">
                                    <th>${lang}: <fmt:message key="cgnt_contentReports.report.column.workflowStarted"/></th>
                                    <th>${lang}: <fmt:message key="cgnt_contentReports.report.column.workflowName"/></th>
                                </c:forEach>
--%>
                            </tr>
                        </thead>
