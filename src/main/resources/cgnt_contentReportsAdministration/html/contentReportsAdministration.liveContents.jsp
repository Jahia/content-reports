    ...
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-md-6" >
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1><fmt:message key="cgnt_contentReports.menu.contentReports.liveContents"/></h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-2">
                        <button type="button" class="btn btn-default"
                                onclick="callTreeView('searchPath',null,'jnt:virtualsite,jnt:page,jnt:navMenuText')">
