...
<fmt:message key="cgnt_contentReports.report.label.insertDescription" var="insertDescription"/>
            ...
            <div class="col-md-12">
                <div class="panel panel-primary panel-primary-datatables filterable">
                    ...
                    <div class="panel-heading">
                        <h5 class="panel-title" id=""><fmt:message key="cgnt_contentReports.report"/>&nbsp;<fmt:message key="cgnt_contentReports.menu.contentReports.pagesWithoutDescription"/></h5>
                    </div>

                    <table width="100%" class="display reports-data-table" id="pageWithoutDescriptionTable" cellspacing="0">
                        <thead>
                            <tr>
