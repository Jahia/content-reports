    ...
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-md-6" >
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1><fmt:message key="cgnt_contentReports.menu.contentReports.futureContents"/></h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6" >
                ...
                <div class="row">
                    <div class="col-md-2">
                        <button type="button" class="btn btn-default"
                                onclick="callTreeView('searchPathFutureContents',null,'jnt:virtualsite,jnt:page,jnt:navMenuText')">
                            <span class="glyphicon glyphicon-folder-open"></span>
                            &nbsp;<fmt:message key="cgnt_contentReports.report.browse"/>
                        </button>
                    </div>
                    <div class="col-md-10">
                        <input type="text" id="searchPathFutureContents" name="searchPathFutureContents" class="form-control" readonly="true"  value="${renderContext.site.path}" >
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <button type="button" class="btn btn-default" onclick="fillReportByFutureContents('${currentNodePath}')">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="panel panel-primary panel-primary-datatables filterable">
                    ...
                    <div>&nbsp;</div>
                    <table width="100%" class="display reports-data-table" id="futureContentTable" cellspacing="0">
                        <thead>
                        <tr>
                            ...
                            <th><fmt:message key="cgnt_contentReports.report.column.liveDate"/></th>
                        </tr>
                        </thead>
                        <tfoot>
                        <tr>
