    ...
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-md-6" >
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1><fmt:message key="cgnt_contentReports.menu.contentReports.customCacheContent"/></h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6" >
                ...
                <div class="row">
                    <div class="col-md-12">
                        <button type="button" class="btn btn-default" onclick="fillReportCustomCacheContent('${currentNodePath}', '${labelLoading}')">
            ...
            <div class="col-md-12">
                <div class="panel panel-primary panel-primary-datatables filterable">
                    ...
                    <div class="panel-heading">
                        <h5 class="panel-title" id=""><fmt:message key="cgnt_contentReports.report"/>&nbsp;<fmt:message key="cgnt_contentReports.menu.contentReports.customCacheContent"/></h5>
                    </div>

                    <table width="100%" class="display reports-data-table" id="customCacheContentTable" cellspacing="0">
                        <thead>
                            <tr>
                                ...
                                <th><fmt:message key="cgnt_contentReports.report.column.expiration"/></th>
