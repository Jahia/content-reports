            ...
            <div class="col-md-12">
                <div class="panel panel-primary panel-primary-datatables filterable">
                    ...
                    <div class="panel-heading">
                        <h5 class="panel-title" id="rba-principal-grid-rdb"><fmt:message key="cgnt_contentGovernor.report"/>&nbsp;<fmt:message key="cgnt_contentGovernor.menu.contentReports.byType"/></h5>
                    </div>
                    <div>&nbsp;</div>
                    <table width="100%" class="display governor-data-table" id="byTypeTable" cellspacing="0">
                        <thead>
                        <tr>
