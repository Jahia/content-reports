    ...
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-md-6" >
                ...
                <div class="row">
                    <div class="col-md-2">
                        <button type="button" class="btn btn-default" onclick="callTreeView('pathTxtRBTD')">
                            <span class="glyphicon glyphicon-folder-open"></span>
                            &nbsp;<fmt:message key="cgnt_contentGovernor.report.browse"/>
                        </button>
                    </div>
                    <div class="col-md-10">
                        <input type="text" id="pathTxtRBTD" name="pathTxtRBTD" class="form-control" readonly="true"  value="${renderContext.site.path}"  >
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <button type="button" class="btn btn-default" onclick="fillReportByTypeDetailed('${currentNodePath}', '${labelTotal}', '${labelLoading}')">
            ...
            <div class="col-md-12">
                <div class="panel panel-primary panel-primary-datatables filterable">
                    ...
                    <div class="panel-heading">
                        <h5 class="panel-title" id=""><fmt:message key="cgnt_contentGovernor.report"/>&nbsp;<fmt:message key="cgnt_contentGovernor.menu.contentReports.byTypeDetailed"/></h5>
                    </div>
                    <div>&nbsp;</div>
                    <table width="100%" class="display governor-data-table" id="byTypeDetailedTable" cellspacing="0">
                        <thead>
                            <tr>
                                <th><fmt:message key="cgnt_contentGovernor.report.column.type"/></th>
                                <th><fmt:message key="cgnt_contentGovernor.report.column.techName"/></th>
        ...
        <div class="row">
            <!-- div tabla -->
            <div class="col-md-12" >
                <canvas id="canvasReportByTypeDetailed"></canvas>
            </div>
        </div>
