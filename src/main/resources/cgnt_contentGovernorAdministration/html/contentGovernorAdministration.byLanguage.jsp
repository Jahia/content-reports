            ...
            <div class="col-md-12">
                <div class="panel panel-primary panel-primary-datatables filterable">
                    ...
                    <div class="panel-heading">
                        <h5 class="panel-title" id=""><fmt:message key="cgnt_contentGovernor.report"/>&nbsp;<fmt:message key="cgnt_contentGovernor.menu.contentReports.byLanguage"/></h5>
                    </div>

                    <table width="100%" class="display governor-data-table" id="byLanguageTable" cellspacing="0">
                        <thead>
                            <tr>
                                <th><fmt:message key="cgnt_contentGovernor.report.column.language"/></th>
                                <th><fmt:message key="cgnt_contentGovernor.report.column.code"/></th>
                                <th><fmt:message key="cgnt_contentGovernor.report.column.availableEdit"/></th>
                                <th><fmt:message key="cgnt_contentGovernor.report.column.availableLive"/></th>
                            </tr>
                        </thead>
                        <tbody></tbody>
                    </table>
