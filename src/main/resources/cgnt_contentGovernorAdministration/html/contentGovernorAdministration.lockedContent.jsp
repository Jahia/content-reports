            ...
            <div class="col-md-12">
                <div class="panel panel-primary panel-primary-datatables filterable">
                    ...
                    <div class="panel-heading">
                        <h5 class="panel-title" id=""><fmt:message key="cgnt_contentGovernor.report"/>&nbsp;<fmt:message key="cgnt_contentGovernor.menu.contentReports.lockedContent"/></h5>
                    </div>

                    <table width="100%" class="display governor-data-table" id="lockedContentTable" cellspacing="0">
                        <thead>
                            <tr>
