            ...
            <div class="col-md-12">
                <div class="panel panel-primary panel-primary-datatables filterable">
                    ...
                    <div class="panel-heading">
                        <h5 class="panel-title" id=""><fmt:message key="cgnt_contentGovernor.report"/>&nbsp;<fmt:message key="cgnt_contentGovernor.menu.contentReports.customCacheContent"/></h5>
                    </div>

                    <table width="100%" class="display governor-data-table" id="customCacheContentTable" cellspacing="0">
                        <thead>
                            <tr>
                                ...
                                <th><fmt:message key="cgnt_contentGovernor.report.column.expiration"/></th>
