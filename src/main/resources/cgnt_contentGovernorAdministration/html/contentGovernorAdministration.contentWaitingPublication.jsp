...
<fmt:message key="cgnt_contentGovernor.report.label.today" var="labelToday"/>
<fmt:message key="cgnt_contentGovernor.report.label.yesterday" var="labelYesterday"/>
<fmt:message key="cgnt_contentGovernor.report.label.daysAgo" var="labelDaysAgo"/>
            ...
            <div class="col-md-12">
                <div class="panel panel-primary panel-primary-datatables filterable">
                    ...
                    <div class="panel-heading">
                        <h5 class="panel-title" id=""><fmt:message key="cgnt_contentGovernor.report"/>&nbsp;<fmt:message key="cgnt_contentGovernor.menu.contentReports.contentWaitingPublication"/></h5>
                    </div>

                    <table width="100%" class="display governor-data-table" id="waitingContentTable" cellspacing="0">
                        <thead>
                            <tr>
