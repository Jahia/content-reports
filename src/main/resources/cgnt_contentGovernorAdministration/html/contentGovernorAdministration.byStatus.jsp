            ...
            <div class="col-md-12">
                <div class="panel panel-primary panel-primary-datatables filterable">
                    ...
                    <div class="panel-heading">
                        <h5 class="panel-title" id=""><fmt:message key="cgnt_contentGovernor.report"/>&nbsp;<fmt:message key="cgnt_contentGovernor.menu.contentReports.byStatus"/></h5>
                    </div>
                    <table width="100%" class="display governor-data-table" id="byTypeStatusTable" cellspacing="0">
                        <thead>
                            <tr>
                                <th><fmt:message key="cgnt_contentGovernor.report.column.status"/></th>
                            </tr>
                        </thead>
                        <tbody></tbody>
                    </table>
        ...
        <div class="nModal-content">
            ...
            <div class="nModal-body">
                ...
                <div class="panel panel-primary panel-primary-datatables filterable">
                    ...
                    <div>&nbsp;</div>
                    <table  width="100%" class="display governor-data-table"  id="byStatusDetailTable" cellspacing="0">
                        <thead>
                            <tr>
