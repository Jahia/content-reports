...
<fmt:message key="cgnt_contentGovernor.menu.contentReports.byAuthor" var="labelAuthor"/>
...
<fmt:message key="cgnt_contentGovernor.report.column.created" var="labelCreated"/>
    ...
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-md-6" >
                ...
                <div class="row">
                    <div class="col-md-12">
                        <label class="label-form"> <fmt:message key="cgnt_contentGovernor.report.typeAuthor"/> </label>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <button type="button" class="btn btn-default" onclick="callTreeView('pathTxt')">
            ...
            <div class="col-md-12">
                <div class="panel panel-primary panel-primary-datatables filterable">
                    ...
                    <div class="panel-heading">
                        <h5 class="panel-title" id="rba-principal-grid"><fmt:message key="cgnt_contentGovernor.report"/>&nbsp;<fmt:message key="cgnt_contentGovernor.menu.contentReports.byAuthor"/></h5>
                    </div>
                    <div>&nbsp;</div>
                    <table width="100%" class="display governor-data-table" id="byAuthorTable" cellspacing="0">
                        <thead>
                            <tr>
                                <th><fmt:message key="cgnt_contentGovernor.report.column.author"/></th>
                                <th id="column-ContentAuthor"><fmt:message key="cgnt_contentGovernor.report.column.created"/></th>
                                <th>%</th>
                            </tr>
                        </thead>
                        <tfoot>
        ...
        <div class="nModal-content">
            ...
            <div class="nModal-body">
                <div class="panel panel-primary panel-primary-datatables filterable">
                    ...
                    <div>&nbsp;</div>
                    <table width="100%" class="display governor-data-table" id="byAuthorDetailTable" cellspacing="0">
                        <thead>
                        <tr>
                            <th><fmt:message key="cgnt_contentGovernor.report.column.type"/></th>
                            <th><fmt:message key="cgnt_contentGovernor.report.column.items"/></th>
                            <th>%</th>
                        </tr>
                        </thead>
                        <tfoot>
        ...
        <div class="nModal-content">
            ...
            <div class="nModal-body">
                <div class="panel panel-primary panel-primary-datatables filterable">
                    ...
                    <div>&nbsp;</div>
                    <table width="100%" class="display governor-data-table" id="byAuthorPageTable" cellspacing="0">
                        <thead>
                            <tr>
